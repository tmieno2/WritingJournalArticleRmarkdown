...
6. Finally, format your manuscript to the specific requirements by the journal
   + create a style reference WORD file and refer to it (see Section @word-specify-style). 
...
In this case, things are just so easy. You never have to get out of Rmarkdown. Just let them edit the Rmarkdown file and keep track of changes using git.
:::
...
## Specifying the style of the output WORD file in detail {#word-specify-style}
