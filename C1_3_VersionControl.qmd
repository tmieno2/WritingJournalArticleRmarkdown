# Version Control (Recommended, but optional)
...
This chapter offers concise and introductory guidance on utilizing **git** and **GitHub** for version controlling your projects. Given RStudio's widespread popularity and comprehensive features as the IDE for R projects, we'll demonstrate how to manage version control using Git and GitHub on RStudio.
...
## Basic Git Workflow Illustration 
...
### Clone the repository and designate it as an RStudio Project on RStudio
...
You then commited this change. But, you realized that you should not be using `rnorm()`. Unfortunatel, you do not remember what you used before. To see the previous version of the same file, you can click on the "History" button. 
